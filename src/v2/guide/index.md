...
Bien que Vue n'utilise pas d'éléments personnalisés en interne, il a une [grande interopérabilité](https://custom-elements-everywhere.com/#vue) quand il est utilisé ou distribué en tant qu'élément personnalisé. La CLI Vue supporte également la construction de composant Vue qui s'enregistrent eux-mêmes en tant qu'éléments personnalisés natifs.
